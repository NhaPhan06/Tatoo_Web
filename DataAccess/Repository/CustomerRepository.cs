...
public class CustomerRepository: GenericRepository<Customer>, ICustomerRepository
{
    ...
    public bool IsFirstNameExist(string name)
    {
        var check = _context.Set<Customer>().FirstOrDefault(c => c.FirstName == name);
        if (check == null)
        {
            return false;
        }
    ...
    public bool IsLastNameExist(string name)
    {
        var check = _context.Set<Customer>().FirstOrDefault(c => c.LastName == name);
        if (check == null)
        {
            return false;
        }
